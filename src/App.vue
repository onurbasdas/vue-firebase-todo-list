...
export default {
  ...
  methods: {
    addTodo() {
      axios
        .post("https://vue-js-1-16f19.firebaseio.com/todoList.json", {
          text: this.todoText
        })
        .then(response => {
          this.todoList.push({
    ...
    deleteTodo(todoId) {
      axios.delete("https://vue-js-1-16f19.firebaseio.com/todoList/" + todoId + ".json")
      .then(response => {
  ...
  created() {
    axios
      .get("https://vue-js-1-16f19.firebaseio.com/todoList.json")
      .then(response => {
